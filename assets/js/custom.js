...
jQuery(document).ready(function(){
	...
	*/
	...
	jQuery("#tgl_keluar").datepicker({
			dateFormat:"dd-mm-yy"
    });
	
	jQuery("#tgl_bayar").datepicker({
			dateFormat:"dd-mm-yy"
    });
	
	jQuery("#tgl_kadaluarsa").datepicker({
			dateFormat:"dd-mm-yy"
    });
	...
	if(jQuery('.alerthtmlbutton').length > 0) {
		jQuery('.alerthtmlbutton').click(function(){
			jAlert('Selamat Anda Dapat Bintang! ');
		});
	}
