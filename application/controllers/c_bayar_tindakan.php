...
//////////////////////////////*  PEMBAYARAN TINDAKAN revisi 23092015 */////////////////////////////////
...
//////////////////////////////*  PEMBAYARAN TINDAKAN  lemot*/////////////////////////////////
	function daftar_bayar_tindakan($par1 = '', $par2 = '', $par3 = '')
	{
		if (!$this->session->userdata('logged_in') == true)
		{
			redirect('login');
		...
		if ($par1 == 'tambah' && $par2 == 'do_update') {
			...
			redirect('c_bayar_tindakan/daftar_bayar_tindakan', 'refresh');
		...
		if ($par1 == 'ubah' && $par2 == 'do_update') {
			...
			$this->m_crud->perbaharui('kd_bayar', $par3, 'btindakan_header', $data);
			...
			$data['edit_bayar_tindakan'] = $this->m_crud->get_bayar_tindakan_by_id_pasien($par2);
		}
		...
		$this->template->display('ubah_bayar_tindakan', $data);
...
/////////////////////* SIMPAN PEMBAYARAN TINDAKAN */////////////////////////////////////////////////	
	public function simpan_tindakan()
	{
			...
			$up['nama_pasien'] 		= $this->input->post('nm_lengkap');
