...
class Cont_transaksi_pendaftaran extends CI_Controller
{
	...
	function pendaftaran($par1 = '', $par2 = '', $par3 = '')
	{
        ...
        $this->table->set_template($tmpl);
 		//$this->table->set_heading('No. Rekam Medis','No KK','Nama Pasien','Alamat','Umur (Tahun)','Metode Pembayaran','Aksi'); bogor timur
		$this->table->set_heading('No. Rekam Medis','Nama Pasien','Alamat','Kelurahan','Umur (Tahun)','Metode Pembayaran','Aksi');
