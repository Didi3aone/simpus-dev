...
class M_lap_mingguan extends CI_Model {
	...
	function get_pelayanan_penyakit_by_date($tgl_mulai, $tgl_akhir, $kd_unit_pelayanan){
        ...
        $sql = $this->db->select('pelayanan_penyakit.kd_penyakit, icd.penyakit,kelurahan.nm_kelurahan, golongan_umur.gol_umur, Count(*) AS jml, pelayanan.kd_unit_pelayanan');
		...
		$sql->group_by('pelayanan_penyakit.kd_penyakit, pasien.kd_kelurahan, pelayanan_penyakit.kd_gol_umur');
