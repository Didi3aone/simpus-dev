<div class="leftpanel">
    ...
    <div class="leftmenu">
	    ...
	    <li class="<?php if($page_name == 'pendaftaran')echo 'active';?>"><a href="<?php echo base_url(); ?>cont_transaksi_pendaftaran/pendaftaran"><span class="icon-align-justify"></span>Daftar Pasien</a></li>
            ...
            <li class="<?php if($page_name == 'pendaftaran')echo 'active';?>"><a href="<?php echo base_url(); ?>cont_transaksi_pendaftaran/pendaftaran"><span class="icon-align-justify"></span>Daftar Semua Pasien</a></li>
            <!--
