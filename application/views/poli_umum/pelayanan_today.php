<style type="text/css">
    ...
    #rawat-inap2 { display: none;}
    #rujuk2 { display: none;}
    #rujuk-rs2 { display: none;}
    #rujuk-poli2 {display: none;}
</style>
					...
					<div id="tabs">
                    			...
                    			<div id="wizard1" class="wizard tabbedwizard">
                                    	...
                                    	<table class="table table-bordered table-stripped table-hover">
                                            ...
                                            <?php if(isset($view_trans_pelayanan) && !empty($view_trans_pelayanan)): ?>
                                            	<?php $i=1; foreach($view_trans_pelayanan as $rs): 
													...
													if ($rs['catatan_dokter'] == '0') { $rs['catatan_dokter']="-";}
                            		...
                            		<div id="wiz1step1_2" class="formwiz content" style="display: none;">
                                        ...
                                        <p>
                                            ...
                                            <span class="field"><textarea cols="80" rows="5" class="span6" name="anamnesa" id="anamnesa2"><?php if($row['anamnesa'] != '0') echo $row['anamnesa']; else echo ""; ?></textarea></span>
                                        </p>
                                        <p>
                                            <label>Catatan Fisik</label>
                                            <span class="field"><textarea cols="80" rows="5" class="span6" name="cat_fisik" id="cat_fisik2"><?php if($row['cat_fisik'] != '0') echo $row['cat_fisik']; else echo ""; ?></textarea></span>
                                        </p>  
                                        <p>
                                            <label>Catatan Dokter</label>
                                            <span class="field"><textarea cols="80" rows="5" class="span6" name="cat_dokter" id="cat_dokter2"><?php if($row['cat_dokter'] != '0') echo $row['cat_dokter']; else echo ""; ?></textarea></span>
                                        </p> 
                                        <h4>Diagnosa</h4>
                                        <p>
                                        ...
                                        <div id="rujuk2">
                                            ...
                                            <div id="rujuk-poli2">
                                                <p>
                                                    ...
                                                    <span class="field">
                                                        <select name="poli_rujukan" id="poli_rujukan2" class="uniformselect">
                                                            <option value="-">Pilih Unit Pelayanan</option>
                                                            <?php foreach($list_unit_pelayanan as $lup) : ?>
                                                                <?php
                                                                if($lup['kd_unit_pelayanan'] == $row['kd_unit_pelayanan'])
                        ...
                        <script type="text/javascript">
							jQuery(document).ready(function () {
                                ...
                                setInterval('$("#dyntable").dataTable().fnDraw()', 10000);
							});
						</script>
...
jQuery(document).ready(function(){
    ...
    <?php if($row['kd_status_pasien'] == "SKP-1" || $row['kd_status_pasien'] == "SKP-2"): ?>
        jQuery('#rujuk2').hide();
    <?php endif; ?>
    <?php if($row['kd_status_pasien'] == "SKP-3"): ?>
        jQuery('#rujuk2').show();
        jQuery('#rujuk-poli2').show();
        jQuery('#rujuk-rs2').hide();
    <?php endif; ?>
    <?php if($row['kd_status_pasien'] == "SKP-4"): ?>
        jQuery('#rujuk2').show();
        jQuery('#rujuk-poli2').hide();
        jQuery('#rujuk-rs2').show();
    <?php endif; ?>
