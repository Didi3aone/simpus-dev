...
<div class="rightpanel">
    ...
    <div class="pagetitle">
    	<h1><?php echo $page_title; ?></h1> <span>Halaman laporan bulanan 4 (LB4) BP Gigi</span>
    </div><!--pagetitle-->
    	...
    	<div class="contentinner content-dashboard">
        	<div class="row-fluid">
            	<div class="span12">
					<div id="tabs">
  	 					<ul>
      						<li class="ui-tabs-active"><a href="#list"><i class="icon-align-justify"></i> Cetak LB4 BP Gigi</a></li>
                        </ul>
                        ...
                        <!---- CETAK LB1 START ---->
   						<div id="list">
                            ...
                            <div class="widgetcontent bordered shadowed nopadding">
                                <?php echo form_open('c_lb_4_gigi/lb4_gigi/cetak', array('class' => 'stdform stdform2', 'id' => 'form_input')); ?>
                                        <p>
                        ...
                        jQuery(document).ready(function(){
                            ...
                            jQuery('#previewModal').on('show', function(){
                                    ...
                                    target = '<?php echo base_url("c_lb_4_gigi/lb4_gigi/preview"); ?>';
                                    //console.log(bln + '\n' + thn);
                                    
                                    var title = 'Laporan Bulanan 4 BP Gigi (' + x + ' ' + thn + ')';
