            	...
            	<div class="span12">
					<div id="tabs">
                    			...
                    			<div id="wizard1" class="wizard tabbedwizard">
                            		...
                            		<div id="wiz1step1_2" class="formwiz content" style="display: none;">
                                        ...
                                        <p>
                                            ...
                                            <span class="field"><textarea cols="80" rows="5" class="span6" name="anamnesa" id="anamnesa2"><?php if($row['anamnesa'] == 0 || $row['anamnesa'] == "" ) echo "-"; else echo $row['anamnesa']; ?></textarea></span>
                                        </p>
                                        <p>
                                            <label>Catatan Fisik</label>
                                            <span class="field"><textarea cols="80" rows="5" class="span6" name="cat_fisik" id="cat_fisik2"><?php if($row['cat_fisik'] == 0 || $row['cat_fisik'] == "" ) echo "-"; else echo $row['cat_fisik']; ?></textarea></span>
                                        </p>  
                                        <p>
                                            <label>Catatan Dokter</label>
                                            <span class="field"><textarea cols="80" rows="5" class="span6" name="cat_dokter" id="cat_dokter2"><?php if($row['cat_dokter'] == 0 || $row['cat_dokter'] == "" ) echo "-"; else echo $row['cat_dokter']; ?></textarea></span>
                                        </p> 
                                        <h4>Diagnosa</h4>
                                        <p>
                        ...
                        <div id="rekam-medis">
 						...
 						<tr>
                                                    <td></td>
                                                    <td><a class="btn" target="_blank" href="<?php echo base_url(); ?>cont_transaksi_pendaftaran/cetak_rm/<?php echo $view_rekam_medis['kd_rekam_medis']; ?>" >Cetak Rekam Medis</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div> <!-- </span6> --> 
