<div class="leftpanel">
        ...
        <!--        <li class="<?php if($page_name == 'dashboard')echo 'active';?>"><a href="<?php echo base_url(); ?>apotik/dashboard"><span class="icon-align-justify"></span>Dashboard</a></li>	-->
				
				<li class="<?php if($page_name == 'apotek')echo 'active';?>"><a href="<?php echo base_url(); ?>barang/apotek"><span class="icon-align-justify"></span>Halaman Depan</a></li>
				...
				<li class="<?php if($page_name == 'obat')echo 'active';?>"><a href="<?php echo base_url(); ?>cont_master_farmasi/obat"><span class="icon-align-justify"></span>Ubah Tanggal Kadaluwarsa</a></li>
				 ...
				 <li class="<?php if($page_name == 'apotek')echo 'active'; ?> dropdown"><a href=""><span class="icon-th-list"></span> Apotek</a>
                	<ul style=" <?php if($page_name == 'apotek')echo 'display: block'; ?>">
                        ...
                        <li><a href="<?php echo base_url(); ?>barang/apotek_keluar/tambah">Obat Keluar Apotek</a></li>
