                                        ...
                                        <?php foreach ($edit_profil_puskesmas as $row_edit): ?>
                                            ...
                                            <table class="table table-bordered table-invoice">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="nm_puskesmas" id="nm_puskesmas" value="<?php echo $row_edit['nm_puskesmas']; ?>" class="input-xlarge" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>NIP Kepala Puskesmas</td>
                                                    <td>
                                                        <input type="text" name="nip_kpl" id="nip_kpl" value="<?php echo $row_edit['nip_kpl']; ?>" class="input-medium" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Nama Kepala Puskesmas</td>
                                                    <td>
                                                        <input type="text" name="kpl_puskesmas" id="kpl_puskesmas" value="<?php echo $row_edit['kpl_puskesmas']; ?>" class="input-xlarge" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Propinsi</td>
                                                ...
                                                <tr>
                                                    <td>Telp</td>
                                                    <td>
                                                        <input type="text" name="telp" id="telp" value="<?php echo $row_edit['telp']; ?>" class="input-xlarge" />
                                                    </td>
                                                </tr>
                                                <tr>
...
<!--                                        --><?php //foreach ($data_profile as $row_prof): ?>
                                        <h4>Informasi Puskesmas</h4>
                                            ...
                                            <p>
                                                <label style="width: 125px">No Telp :</label>
                                                <input type="text" name="telp" class="input-xlarge" style="font-weight: bold" value="<?php echo $row_prof['telp']; ?>" readonly/>
                                            </p>
                                            <p>
