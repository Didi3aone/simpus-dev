            ...
            <div class="widgetcontent bordered">
                ...
                <div class="row-fluid">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td><input type="text" value="UPDATE Data Pasien"></td>
                            <td><a class="btn btn-danger btn-rounded" href="#" id="uptPasien">
                                    <i class="iconsweets-trashcan iconsweets-white"></i>
                                    Update !
                                </a>
                            </td>
...
<script>
	...
	$(document).ready(function(){
		...
		$('#uptPasien').click(function() {
			jConfirm('Apakah anda ingin mengubah data master pasien?', 'Konfirmasi', function(r) {
				  if(r==true){
					  $.ajax({
                          cache: false,
                          type: "POST",
                          dataType: "json",
                          url: '<?php echo base_url().'reset/updatePasien'; ?>',
                          xhr: function () {
                              var xhr = new window.XMLHttpRequest();
                              //Download progress
                              xhr.addEventListener("progress", function (evt) {
