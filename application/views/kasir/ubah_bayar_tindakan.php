						  ...
						  <div class="span6">
						   <table class="table table-bordered table-invoice">
                               <tr>
                                   ...
                                   <td>
                                       <input type="text" id="nik2" name="nik2" style="width:200px; font-size: 12px; " value="<?php echo $row['kd_rekam_medis']; ?>" readonly>
                                      
                                   </td>
                               </tr>
                               <tr>
                                   <td>Nama Pasien</td>
                                   <td><input type="text" name="nm_lengkap" id="nm_lengkap" style="width:200px; font-size: 12px; " value="<?php echo $row['nm_lengkap']; ?>" readonly></td>
                               </tr>
							</table>
						  </div>
...
<!--						<button type="button" name="list_tind" id="list_tind" class="btn btn-success"><i class="icon-plus-sign icon-white"></i> Panggil Tindakan</button>-->
                ...
                <div class="widgetcontent">
						...
						<div class="span6">
						  ...
						  <table class="table table-bordered table-invoice">
							  <tr>
								...
								<input type="text" style="width:100px; font-size: 15px; " name="kd_produk" id="kd_produk" value="<?php echo $kd_produk; ?>" placeholder="..." /><button type="button" name="list_barang" id="list_barang" class="btn btn-danger btn-small" title="Cari Tindakan"><i class="icon-list-alt icon-white"></i> Tindakan</button>
							  <tr>
								<td>Nama Produk</td>
						...
						<td align="center">
							...
							<a href="<?php echo base_url(); ?>c_bayar_tindakan/daftar_bayar_tindakan"> 
			...
			<!--///////////////////* MODAL *///////////////////////////////////////////////////////////-->		
						...
						<!---- DAFTAR bayar START ---->
   						<div id="list">
                        	<a href="<?php echo base_url(); ?>c_bayar_tindakan/daftar_bayar_tindakan/tambah"> 
                    		...
                    		<thead>
                                <tr>
                                    ...
                                    <th class="head0 center">No RKM</th>
							...
							?>
                            	<tr class="gradeX">
                                	<td class="aligncenter">
	                                    ...
	                                    <td class="center"><?php echo $r['kd_rekam_medis']; ?></td>
									...
									<td class="center" width="15%">
                                    	<a href="<?php echo site_url();?>c_bayar_tindakan/cetak/<?php echo $r['kd_bayar']; ?>" class="btn btn-warning btn-circle" title="Cetak" target="_blank"><i class="iconsweets-printer iconsweets-white"></i></a>
					<!-- <a href="<?php echo base_url(); ?>c_bayar_tindakan/daftar_bayar_tindakan/ubah/<?php echo $r['kd_bayar']; ?>" class="btn btn-primary btn-circle" title="Edit"><i class="iconsweets-create iconsweets-white"></i></a>	-->
                                        <a href="<?php echo base_url(); ?>c_bayar_tindakan/daftar_bayar_tindakan/hapus/<?php echo $r['kd_bayar']; ?>" class="btn btn-danger btn-circle" onClick="return confirm('Anda yakin ingin mengurangi data ini?')" title="Hapus !"><i class="iconsweets-trashcan iconsweets-white" ></i></a>
                                    </td>
                                </tr>
                              <?php 
							  $no++;
