<div class="leftpanel">
		...
		<li class="<?php if($page_name == 'pembayaran')echo 'active';?>"><a href="<?php echo base_url(); ?>c_bayar_tindakan/bayar_tindakan/tambah"><span class="icon-align-justify"></span>Menu Kasir</a></li>
        
        <li class="<?php if($page_name == 'pelayanan')echo 'active';?>"><a href="<?php echo base_url(); ?>c_bayar_tindakan/daftar_bayar_tindakan/list"><span class="icon-align-justify"></span>Daftar Pembayaran Hari Ini</a></li>
