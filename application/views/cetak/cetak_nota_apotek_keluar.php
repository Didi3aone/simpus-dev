...
//    $kop    .="<p>TELP. $telp </p>";
//    $kop	.= "<p>".$nm_kelurahan." - ".$nm_kecamatan."</p>";
//    $kop	.= "<p>".$nm_kota." - ".$nm_propinsi."</p>";



    $kop_kanan  =$tgl_keluar;
    $kop_kanan  .= "<p></p>";
    ...
    function myheader($kop,$kop_kanan,$judul_H,$kop_noreg){
        ...
        <div class="page">
            ...
            <table width="100%">
                ...
                <tr>
                    <td>No. Trans </td><td>:</td><td><?php echo $judul_H; ?></td>
                </tr>
                <tr>
...
//        $jml = $jml;
	...
	<tr>
            ...
            <td align="right"><?php echo $db['qty']; ?>  <?php echo $db['sing_sat_kecil_obat'];?></td>
        </tr>
        <?php
        $no++;
    }
    ...
    <div class="page" >
	    ...
	    <tr>
                <td>Poli</td><td>:</td><td><?php echo $nm_unit; ?></td>
            </tr>
            <tr>
                <td>Pasien</td><td>:</td><td><?php echo $nm_lengkap; ?></td>
            </tr>
	    <tr>
            ...
            <tr>
                <td>Pembayaran</td><td>:</td><td><?php echo $cara_bayar; ?></td>
            </tr>
        </table>
    </div>
<?php
