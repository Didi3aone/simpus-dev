            	...
            	<div class="span12">
					<div id="tabs">
                     ...
                     <!--       <li class="<?php if(!isset($edit_pendaftaran) && !isset($view_rekam_medis))echo 'ui-tabs-active';?>"><a href="#list"><i class="icon-align-justify"></i> Daftar Semua Pasien</a></li>
                            -->
                            <li class="<?php if(!isset($edit_pendaftaran) && !isset($view_rekam_medis))echo 'ui-tabs-active';?>"><a href="#tambah"><i class="icon-plus"></i> Pendaftaran Pasien Baru</a></li>
							
                            <li class=""><a href="#list"><i class="icon-align-justify"></i> Daftar Semua Pasien</a></li>
...
jQuery(document).ready(function(){
	...
	jQuery("#kd_propinsi").chosen().change(function(){
	 ...
	 jQuery("#kd_propinsi2").chosen().change(function(){
		...
		jQuery("#kd_kelurahan2").html('').trigger("liszt:updated");
	 ...
	 //new
	 jQuery("#kd_kecamatan2").chosen().change(function(){
		var kd_kecamatan = jQuery("#kd_kecamatan2").val();
		console.log(kd_kecamatan);
			...
			jQuery.ajax({
				...
				data: 'kd_kecamatan=' + kd_kecamatan,
				success: function(data) {
					jQuery('#kd_kelurahan2').html(data).trigger("liszt:updated");
				},  
		   error: function(e){  
				alert('Error: ' + e);  
			}  
